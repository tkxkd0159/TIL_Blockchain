...
const nw = require("./submodule/network");
const wl = require("./submodule/wallet");
const ut = require("./submodule/utils");

const http_port = process.env.HTTP_PORT || 3001;
const initialPeers = process.env.PEERS ? process.env.PEERS.split(",") : [];

function initHttpServer() {
  const bc = require("./submodule/blockchain");
