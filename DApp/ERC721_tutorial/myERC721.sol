...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.1.0/contracts/utils/introspection/ERC165.sol";
...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.1.0/contracts/utils/structs/EnumerableSet.sol";
...
contract MyERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(MyERC721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
